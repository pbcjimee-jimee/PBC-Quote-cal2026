...
- [ ] **Step 4: Run GREEN and related auth/PWA tests**
...
- [ ] **Step 1: Add a failing profile batch test**
...
- [ ] **Step 2: Add failing quote-detail enrichment coverage**
...
- [ ] **Step 3: Add failing thin-client-prop coverage**
...
- [ ] **Step 5: Implement the authenticated profile batch**
...
- [ ] **Step 6: Replace wildcard detail selects**
...
- [ ] **Step 7: Bound profile enrichment**
...
- [ ] **Step 8: Introduce the thin refresh DTO**
...
- [ ] **Step 1: Write failing gateway reuse tests**
...
- [ ] **Step 2: Write failing bounded snapshot tests**
...
- [ ] **Step 3: Write failing action integration test**
...
- [ ] **Step 5: Implement the gateway object**
...
- [ ] **Step 6: Implement bounded snapshot loading**
...
- [ ] **Step 7: Thread the context through Jobs actions**
...
- [ ] **Step 8: Run GREEN and authorization regressions**
...
- [ ] **Step 2: Write failing server-filter UI tests**
...
- [ ] **Step 4: Extend validation and the action**
...
- [ ] **Step 5: Update the route and client**
...
- [ ] **Step 6: Preserve export semantics**
...
- [ ] **Step 5: Run GREEN and calculation regressions**
...
- [ ] **Step 1: Write failing lazy-module behavior tests**
...
- [ ] **Step 2: Write failing loading-route tests**
...
- [ ] **Step 4: Extract tab views without moving controller state**
...
- [ ] **Step 6: Add route-shaped loading files**
...
- [ ] **Step 3: Compare deterministic bundles**

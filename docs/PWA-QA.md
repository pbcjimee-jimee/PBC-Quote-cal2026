...
- [x] TypeScript, ESLint, 전체 Vitest(65 files, 543 tests 통과; 환경 조건 1 file·2 tests skip), coverage, production build, diff check, high-severity audit(0 vulnerabilities)

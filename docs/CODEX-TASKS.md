...
> 구현 담당은 Codex 5.5, 설계·스코프 판단은 Opus 4.8(`AGENTS.md`·`docs/AGENT-MAP.md`).
...
계획·스코프 재조정이 필요하면 설계는 `Opus 4.8 extra`가 사용자와 확인해 문서화하고, 구현은 `Codex 5.5 high`가 그 문서를 기준으로 수행한다.

...
- **UX 잔여**: `docs/UI-UX-REVIEW.md`(2026-07-28 전면 재리뷰) 기준 R1·R2는 2026-07-28 반영 완료. 남은 것은 R3~R5 — 대비 토큰 재배치(`--muted-2`·상태색), 상태 화면(error/not-found 바운더리·loading 정합·검색/PaintSearch pending·Save & Sync 성공 피드백), 인터랙션 함정, 디자인 시스템 위반 잔여, 반응형/터치 잔여, P2/P3 폴리시. UX 부채는 `docs/BACKLOG.md` P6에 등록됨(2026-07-28 사용자 승인).
